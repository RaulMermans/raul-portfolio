...
export const caseStudiesContent: Record<string, CaseStudyContent> = {
  'ai-sports': {
    ...
    hero: {
      ...
      description: 'Building campaign-grade coherence from generative AI through systematic automation and creative direction.',
      image: {
    ...
    overview: {
      title: 'Overview',
      description:
        'Everyone can generate "cool" images now. Almost no one can generate consistent campaigns. I built a custom n8n automation—a Creative Direction Engine—that takes one reference campaign shot and lets me swap the model and wardrobe while keeping lighting, environment, and shot DNA stable.',
      meta: [
    ...
    sections: [
      {
        title: 'The Challenge',
        content:
          'The baseline problem with generative image workflows is drift: change one thing and everything changes—lighting, texture, camera feel, even the "world" itself. That\'s fine for one-off visuals, but campaigns demand continuity: the audience should feel like every asset came from the same production.',
      },
      {
        title: 'The Approach',
        content:
          'I designed the automation around a "constants vs variables" model—first locking the non-negotiables of the reference shot, then giving controlled flexibility to casting and wardrobe. The workflow ingests three visual inputs and routes them through a repeatable pipeline that prioritizes continuity over novelty.',
      },
    ],
    gallery: [
      {
