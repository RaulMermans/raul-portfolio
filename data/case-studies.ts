  ...
  en: [
    {
      ...
      slug: 'relay',
      title: 'Relay',
      description: 'Marketing intelligence workspace that turns Meta Ads, Google Ads, and Shopify exports into validated performance reporting.',
      commercialRelevance: 'Shows how a reporting workflow can keep ecommerce revenue, platform attribution, data quality, and interpretation distinct and inspectable.',
      tags: ['Marketing Intelligence', 'Data Health', 'Reporting', 'Next.js', 'TypeScript'],
    ...
    },
    {
      ...
      cta: 'View case study',
      image: '/images/case-studies/opstwin/thumb.webp',
      imageWidth: 1672,
      imageHeight: 941,
      color: 'var(--accent)',
    ...
    },
    {
      ...
      title: 'SearchSignal',
      description:
        'Inspectable catalog-readiness framework for finding ecommerce data issues before keyword, semantic, or hybrid search goes live.',
      commercialRelevance:
        'Shows how search quality can be treated as a catalog and information-architecture problem before it becomes a ranking problem.',
      tags: [
        'Ecommerce Search',
        'Catalog Readiness',
      ...
      cta: 'View case study',
      image: '/images/case-studies/searchsignal/thumb.svg',
      imageWidth: 1200,
      imageHeight: 800,
      color: 'var(--color-0)',
      subtitle: 'Ecommerce search / Catalog readiness framework',
      mood: ['minimal', 'tech', 'editorial'],
      githubUrl: 'https://github.com/RaulMermans/SearchSignal',
      liveUrl: 'https://search-signal.vercel.app',
    },
    {
      id: 10,
      slug: 'demandos',
  ...
  es: [
    {
      ...
      slug: 'relay',
      title: 'Relay',
      description: 'Espacio de inteligencia de marketing que convierte exportaciones de Meta Ads, Google Ads y Shopify en reporting de rendimiento validado.',
      commercialRelevance: 'Muestra cómo un flujo de reporting puede mantener separados e inspeccionables los ingresos ecommerce, la atribución de plataforma, la calidad de datos y la interpretación.',
      tags: ['Inteligencia de marketing', 'Data Health', 'Reporting', 'Next.js', 'TypeScript'],
    ...
    },
    {
      ...
      title: 'SearchSignal',
      description:
        'Framework inspeccionable de preparación de catálogo para detectar problemas de datos ecommerce antes de desplegar búsqueda por keyword, semántica o híbrida.',
      commercialRelevance:
        'Muestra cómo la calidad de búsqueda se puede tratar como un problema de catálogo y arquitectura de información antes de convertirse en un problema de ranking.',
      tags: [
        'Búsqueda ecommerce',
      ...
      imageHeight: 800,
      color: 'var(--color-0)',
      subtitle: 'Búsqueda ecommerce / Framework de preparación de catálogo',
      mood: ['minimal', 'tech', 'editorial'],
      githubUrl: 'https://github.com/RaulMermans/SearchSignal',
      liveUrl: 'https://search-signal.vercel.app',
    },
