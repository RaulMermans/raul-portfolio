...
export const siteConfig = {
  ...
  defaultTitle: 'Raúl Mermans — AI Systems for Brand and Creative Teams',
  defaultDescription:
    'Designer and builder of AI systems for brand and creative teams, combining strategic judgment, interface design, workflow architecture, and functioning prototypes.',
  defaultImage: {
...
export const defaultKeywords = [
  ...
  'flujos de IA para equipos creativos',
  'AI workflows for creative teams',
  'herramientas de IA',
  'AI tools',
