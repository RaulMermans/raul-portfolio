  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'DataBrief AI',
        item: `${siteConfig.url}/es/case-studies/data-brief-ai`,
      },
    ],
  }
...
export default function SpanishDataBriefAiLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <StructuredData
        type="Article"
        data={{
          '@id': `${siteConfig.url}/#data-brief-ai-case-study-es`,
          headline: title,
          name: 'DataBrief AI',
          description,
          url: absoluteRouteUrl('/es/case-studies/data-brief-ai'),
          mainEntityOfPage: absoluteRouteUrl('/es/case-studies/data-brief-ai'),
