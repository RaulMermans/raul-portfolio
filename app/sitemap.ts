...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const localizedDefinitions = [
    ...
    { path: '/lab', changeFrequency: 'monthly', priority: 0.62 },
    { path: '/services/ai-systems', changeFrequency: 'monthly', priority: 0.84 },
    { path: '/services/automation', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/services/prototypes', changeFrequency: 'monthly', priority: 0.76 },
    { path: '/services/brand-systems', changeFrequency: 'monthly', priority: 0.78 },
