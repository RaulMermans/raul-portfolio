...
export default function EnglishCampaignPulseLayout({ children }: { children: React.ReactNode }) {
  const url = absoluteRouteUrl('/en/case-studies/campaign-pulse')
  ...
  return (
    <>
      ...
      <StructuredData
        type="Article"
        data={{
          '@id': `${siteConfig.url}/#campaign-pulse-case-study-en`,
          headline: title,
          name: 'Campaign Pulse',
          description,
          url,
