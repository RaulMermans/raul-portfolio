...
interface AppDetailPageViewProps {
  params: {
    slug: string
  }
}
...
interface AppDetailPageViewPropsWithLocale extends AppDetailPageViewProps {
  locale?: Locale
}

export function AppDetailPageView({ params, locale = 'en' }: AppDetailPageViewPropsWithLocale) {
