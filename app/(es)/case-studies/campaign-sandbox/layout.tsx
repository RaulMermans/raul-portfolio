...
export default function CampaignSandboxLayout({ children }: { children: React.ReactNode }) {
  const url = absoluteRouteUrl('/case-studies/campaign-sandbox')
  ...
  return (
    <>
      ...
      <StructuredData
        type="Article"
        data={{
          '@id': `${siteConfig.url}/#campaign-sandbox-case-study`,
          headline: title,
