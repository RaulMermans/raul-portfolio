    ...
    <section id="contact" className="contact" aria-labelledby="contact-title">
      ...
      <div className="contact__content">
        ...
        <div className="ai-products reveal reveal-delay-3">
          ...
          <div className="ai-products__links">
            <a href="https://promptbase.com/profile/mangerm" className="btn" target="_blank" rel="noopener noreferrer">Image Prompts</a>
            <a href="https://raulmermans.gumroad.com/" className="btn" target="_blank" rel="noopener noreferrer">Gumroad Store</a>
          </div>
        </div>
